...
# --- Создание директории ---
if not os.path.exists('verification_large_conv'):
    os.makedirs('verification_large_conv')
...
x_file = 'verification_large_conv/x_1024.bin'
y_file = 'verification_large_conv/y_1024.bin'
...
numpy_conv_file = 'verification_large_conv/numpy_conv_1024.bin'
