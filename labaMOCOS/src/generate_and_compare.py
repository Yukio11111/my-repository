...
# --- Создание директории ---
if not os.path.exists('verification_data'):
    os.makedirs('verification_data')
...
signal_file = 'verification_data/signal_1024.bin'
...
numpy_spectrum_file = 'verification_data/numpy_fft_1024.bin'
